				  ...
				  struct snd_soc_dai *dai)
{
	...
	if (substream->stream == SNDRV_PCM_STREAM_CAPTURE) {
        ...
        //ADD START
		val = channels == 1 ? BIT(2) : channels == 2 ? BIT(0) | BIT(1) : BIT(0) | BIT(1) | BIT(2);  //ADC3 for ch=1; ADC12 for ch=2
...
//ADD START
static const DECLARE_TLV_DB_RANGE(sun20i_codec_pga_vol_scale,
				0, 0, TLV_DB_SCALE_ITEM(0, 0, 0),
				1, 3, TLV_DB_SCALE_ITEM(600, 0, 0),
				4, 0x1f, TLV_DB_SCALE_ITEM(900, 100, 0),
);
//ADD END
/* FIXME */ /* FIXED */
...
static const struct snd_kcontrol_new sun20i_codec_controls[] = {
	...
	SOC_SINGLE_TLV("Mic2 Capture Volume",
			    ...
			    0x1f, 0, sun20i_codec_pga_vol_scale),
	SOC_SINGLE_TLV("Mic3 Capture Volume",
			    SUN20I_CODEC_ADC3,
...
static const struct snd_soc_dapm_widget sun20i_codec_widgets[] = {
	...
	/* Capture */
	SND_SOC_DAPM_AIF_OUT("ADC FIFO", "Capture", 0,
			     SND_SOC_NOPM, 0, 0),
	// SND_SOC_DAPM_AIF_OUT("ADC1 FIFO", "Capture", 0,
	// 		     SND_SOC_NOPM, 0, 0),
	// SND_SOC_DAPM_AIF_OUT("ADC2 FIFO", "Capture", 0,
	// 		     SND_SOC_NOPM, 0, 0),
	// SND_SOC_DAPM_AIF_OUT("ADC3 FIFO", "Capture", 0,
	// 		     SND_SOC_NOPM, 0, 0),
